            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <button id="btn-dashboard" class="nav-link">
                        <img src="{{ asset('images/data.png') }}" alt="Dashboard" class="option_icon">Clearance Status
                    </button>

                </li>
                <li class="nav-item">
                    <button id="btn-clearance" class="nav-link clearance">
                        <img src="{{ asset('images/summary.png') }}" alt="Clearance" class="option_icon">View Document
                    </button>
                </li>
                <li class="nav-item">
